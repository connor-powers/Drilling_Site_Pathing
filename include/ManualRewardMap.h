...
class ManualRewardMap {
 ...
 public:
  ...
  void add_site(
      ...
      double reward_val);  // overloading to allow direct addition of a site
                           // through its coordinates and reward val
  ...
  // nearest-neighbor method. If this is the case, pass the associated distance
  // weight as the third argument.

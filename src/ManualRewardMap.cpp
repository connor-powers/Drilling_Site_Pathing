...
void ManualRewardMap::draw_map_with_paths(const std::vector<site> input_sorted_site_list, std::string input_path_type, double associated_distance_weight){
...
std::pair<std::vector<site>,double> ManualRewardMap::generate_paths_descending_priority(){

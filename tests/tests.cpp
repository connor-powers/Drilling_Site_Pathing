...
TEST(TestSuite,ZeroWeightDistance){
    ...
    // Going to keep demonstrations of all site-adding workflows (manually entered parameters vs. randomly generated, adding site objects by directly 
    // passing site objects or entering (x,y,reward_val)) to make sure none of those break
